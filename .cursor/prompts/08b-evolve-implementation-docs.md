# Evolve Implementation Documentation (Prompt 08b)

Use this prompt to update **implementation documentation** after an architecture evolution. This is **Phase 9b** of the Vision-to-System Framework.

Run this prompt after completing **Prompt 08a** (architecture evolution). After completing this prompt, use **Prompt 08c** to update user documentation, then **Prompt 05** to implement code changes.
...
1. Ensure **Prompt 08a is complete** and the Evolution Impact Plan exists
2. Open a **new** Cursor conversation
3. Copy everything from the "Prompt" section above
4. Replace `{PATH TO EVOLUTION IMPACT PLAN}` and `{ADR-ID}` with the actual values
5. Send — the AI will update component records and the Implementation Plan
6. Review all changes
7. Open another **new** conversation with **Prompt 08c** to update user documentation
