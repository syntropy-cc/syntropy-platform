/**
 * ContributorHighlights — top contributors with portfolio links (COMP-036.2).
 * Server component; receives contributors from parent or fetches when API is available.
 */
