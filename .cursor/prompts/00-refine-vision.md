# Refine Vision (Prompt 00)

Use this prompt to assess and improve a Vision Document before architecture generation. This is **Phase 0** of the Vision-to-System Framework — an optional but strongly recommended step before running Prompt 01.
...
1. Ensure your Vision Document exists at `docs/vision/VISION.md` (using `.cursor/templates/vision/VISION-TEMPLATE.md`)
2. Open a **new** Cursor conversation
3. Copy everything from the "Prompt" section above into the conversation
4. Send — the AI will assess your Vision Document and guide you through improvements
5. After this session, use **Prompt 01** (`.cursor/prompts/01-generate-architecture-from-vision.md`) to generate the architecture

**Note**: This prompt is optional if your Vision Document is already comprehensive. Prompt 01 includes an automatic quality check and will direct you here if the document does not meet minimum thresholds.
