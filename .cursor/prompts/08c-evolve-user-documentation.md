# Evolve User Documentation (Prompt 08c)

Use this prompt to update **user-facing documentation** after an architecture evolution. This is **Phase 9c** of the Vision-to-System Framework.

Run this prompt after completing **Prompt 08a** (architecture evolution) and **Prompt 08b** (implementation documentation). After completing this prompt, use **Prompt 05** to implement code changes.
...
1. Ensure **Prompts 08a and 08b are complete**
...
5. Send — the AI will update documentation pages, create new ones, and verify alignment
6. Review all documentation changes
7. Open another **new** conversation with **Prompt 05** to implement the code changes
