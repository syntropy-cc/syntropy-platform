 ...
 */
export { Sponsorship, isSponsorshipType, type SponsorshipParams, type SponsorshipType, } from "./domain/sponsorship.js";
export { SponsorshipStatus, isSponsorshipStatus, } from "./domain/sponsorship-status.js";
export { SponsorshipDomainError, InvalidSponsorshipTransitionError, } from "./domain/errors.js";
export type { PaymentGateway, PaymentIntentResult, WebhookResult, } from "./domain/ports/payment-gateway.js";
...
export type { ImpactDataProvider, ImpactDataSnapshot, } from "./domain/ports/impact-data-provider.js";
...
export { SponsorshipEventPublisher, type SponsorshipEventPayload, } from "./infrastructure/sponsorship-event-publisher.js";
