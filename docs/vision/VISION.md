...
| Project Management | Complete project management environment — issues, roadmap, contribution review, artifact management | Project Creation (belongs to institution; contract must be ≤ permissive than institution's governance contract), Issue Management, Contribution Review (artifact submitted → reviewed → accepted/rejected → integrated), Artifact Manifest Management, Roadmap and Planning, ContributionSandbox (Hackin dimension) | Issues that are public are visible to any Hub user if the project is public; ContributionSandbox is available to every contributor who has access to the artifact (including on private/closed projects); sandbox artifacts do not have the same formal contracts as main dimension until deliberately promoted |
...
| 30 | **Hackin Dimension per Project (ContributionSandbox)** | Every project has a sandbox dimension for safe contribution: isolated instance, clone artifact, edit with feedback, optional pull request. Available to every contributor who has access to the artifact (including owners and authorized contributors on private or closed projects). Applies to all DIP artifact types. | MVP |
...
| Project (Hub) | Entity grouping related artifacts within an institution; defines the collaboration context and artifact manifesto | Name, artifact manifesto, monetization protocol, open issues, visibility, ContributionSandbox dimension | Institution, Artifact, Issue, Contribution | Member with permission | Draft → Active → Archived |
...
| ContributionSandbox (Hackin dimension) | The mechanism that provides a safe contribution workflow: isolated instance or container, clone of the artifact, contributor edits and sees effects, optional pull request. Available to every contributor who has access to the artifact (including on private or closed projects). Applies to all DIP artifact types. Parallel to the main dimension; experiments and prototypes without formal contracts until promotion | Experiments, prototypes, draft artifacts, absence of formal contracts until promotion | Project | Any contributor with artifact access | Active (always parallel to main project) |
