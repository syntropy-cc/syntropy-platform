...
export interface FooterProps {
  ...
  /** Copyright line. */
  copyright?: string;
  /** Optional logo (e.g. <Logo src="..." />) in first column above brand name. */
        ...
        <div className="grid gap-8 md:grid-cols-4">
          {(logo != null || tagline != null) && (
            <div className="md:col-span-1">
              <a href="/" className="inline-flex flex-col gap-2 text-foreground">
                {logo}
                <span className="text-lg font-medium">Syntropy</span>
              </a>
