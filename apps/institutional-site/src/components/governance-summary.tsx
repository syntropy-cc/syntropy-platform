/**
 * GovernanceSummary — active governance contract summary, proposal count (COMP-036.2).
 * Server component; receives data from parent or fetches from API.
 */
...
export interface GovernanceSummaryProps {
  ...
  /** Optional: governance contract type/summary when API provides it */
  contractType?: string;
