# Generate User Documentation (Prompt 07)

Use this prompt after implementation is complete (all stages done) to generate user-facing documentation and a documentation portal. This is **Phase 7** of the Vision-to-System Framework.
...
1. Ensure all implementation stages are complete (Phase 6 done)
2. Open a **new** Cursor conversation
3. Copy everything from the "Prompt" section above
4. Send — the AI will analyze the system and generate all user documentation
5. Review the generated documentation
6. Preview the portal with `mkdocs serve -f docs/mkdocs.yml`
7. Deploy the portal (Phase 8 — see FRAMEWORK.md for deployment options)
