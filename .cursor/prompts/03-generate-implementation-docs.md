# Generate Implementation Documentation (Prompt 03)

Use this prompt to transform finalized architecture into implementation documentation (component records and backlog). This is **Phase 4** of the Vision-to-System Framework.
...
1. Ensure your architecture is complete and reviewed (Phase 2–3 done)
2. Open a **new** Cursor conversation
3. Copy everything from the "Prompt" section above
4. Send — the AI will read architecture, extract components, and generate all implementation docs
5. Review the component records and backlog
6. Proceed to **Prompt 04** (`.cursor/prompts/04-generate-implementation-plan.md`)
