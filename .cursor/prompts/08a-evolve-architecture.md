# Evolve Architecture (Prompt 08a)

Use this prompt to evolve the **architecture** of an implemented system. This is **Phase 9a** of the Vision-to-System Framework.

After completing this prompt:
- Use **Prompt 08b** to update implementation documentation
- Use **Prompt 08c** to update user documentation
- Use **Prompt 05** to implement code changes
...
4. Send — the AI will analyze impact, create ADRs, update architecture docs, and produce the Evolution Impact Plan
5. Review all changes
6. Open another **new** conversation with **Prompt 08b** to update implementation documentation
